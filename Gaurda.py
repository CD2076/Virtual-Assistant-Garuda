...
def wishme():
   ...
   speak("Garuda at your service. Please tell me how can i help you?")
...
def where_born():
    speak('I was created by a magician named CHANDAN, in the Dev Bhoomi Himachal Pradesh .')

def how_are_you():
    speak('I am fine, thank you. How can help you Sir?')

#speak('Initializing Garuda...')
#wishme()
#query = takeCommand()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'time' in query:
            ...
            speak("I am Garuda, The Smart Assistant of CHANDAN, Developed to help him around with his work and makes his life easier with his machine")
